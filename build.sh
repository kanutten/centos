...
dnf -y install "https://mirrors.rpmfusion.org/free/el/rpmfusion-free-release-$MAJOR_VERSION_NUMBER.noarch.rpm"
dnf -y install "https://mirrors.rpmfusion.org/nonfree/el/rpmfusion-nonfree-release-$MAJOR_VERSION_NUMBER.noarch.rpm"
dnf -y install fuse \
flameshot \
fuse-libs
#flameshot \
